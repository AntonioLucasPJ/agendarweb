...
export const NewAppProvider = ({ children }) => {
    ...
    return (
        <NewAppointments value={{ id_mecanico,setidmecanico, id_service, setidservice, mecanicosapi, setmecanicosapi, serviceapi, setserviceapi, selectdata, setselectdata, booking_hour, setbookhours, notification, activenotification, setactivenotification,CreateAppointment, EditAppointment }}>{children}</NewAppointments>
    )
} 